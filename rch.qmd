...
- RCH's academic career has been marked by a number of notable publications, spans several decades, and includes a wide range of topics (let your cursor hover over a highlighted reference date to see the full citation)
...
- Note also the dynamic scrollable reference section at the end of the presentation that can be incorporated into a single slide and contain the full list of references noted above
...
- As well, `\label{}` and `\eqref{}` commands are supported thanks to MathJax
...
- These examples are borrowed shamelessly from <https://quarto.org/docs/presentations/revealjs> (with a few modifications)

- This link provides a more detailed discussion of the dynamic capabilities of reveal.js, far more than we could ever accomplish here, and I encourage you to explore it further

## Executable Code

- Copy-and-pasting of executable code chunks can be incorporated into your presentation, and its output can be displayed as well (hover your cursor over the upper right corner of the code box until a clipboard icon appears, then click on the icon to copy the code then paste it into R/RStudio and run it)
...
- If you remain unimpressed by the dynamic capabilities of reveal.js, then you are likely a lost cause, and RCH might be inclined to tell you to "Arrr, Get Yer Own Damn Festschrift!"
...
- True out the chalk board, notes canvas, multiplexing, and other features of reveal.js that can enhance your presentations, engage your audience, and upgrade your skillset for teaching econometrics and sharing your work with the world
